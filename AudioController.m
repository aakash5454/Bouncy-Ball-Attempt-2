...
@property (assign) SystemSoundID shotGunFire;
...
- (void)configureSystemSound {
    ...
    NSString *shotGunFirePath = [[NSBundle mainBundle] pathForResource:@"shot-Gun-Fire" ofType:@"caf"];
    NSURL *shotGunFireURL = [NSURL fileURLWithPath:shotGunFirePath];
    AudioServicesCreateSystemSoundID((__bridge CFURLRef)shotGunFireURL, &_shotGunFire);
}
